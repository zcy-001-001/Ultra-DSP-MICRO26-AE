...
set report_dir [file join $script_dir results pure_lut_reduction_ooc]
...
write_checkpoint -force [file join $report_dir W4A4_P_pure_lut_synth.dcp]
report_utilization \
...
write_checkpoint -force [file join $report_dir W4A4_P_pure_lut_opt.dcp]
report_utilization \
