...
// W5A5_array black-box function prototype (NO mode)
void W5A5_array(
    ap_int<5> w0[NUM_DSP],
    ap_int<5> w1[NUM_DSP],
    ap_int<5> a0[DSP_ARRAY_ROWS],
    ap_int<5> a1[DSP_ARRAY_ROWS],
    ap_int<10> result0[NUM_DSP],
    ap_int<10> result1[NUM_DSP],
    ap_int<10> result2[NUM_DSP],
    ap_int<10> result3[NUM_DSP]);
...
extern "C" void gemv_kernel(
    ...
    static ap_int<10> result0_arr[NUM_DSP];
    static ap_int<10> result1_arr[NUM_DSP];
    static ap_int<10> result2_arr[NUM_DSP];
    static ap_int<10> result3_arr[NUM_DSP];
