...
// Per-PE packed multiply counts (single mode, no prefill/decoding split)
#define WEIGHTS_PER_PE 2

// Input/output tensor sizes
// 2 activations per PE -> 2 accumulation channels -> 2 * COLS outputs
...
// Kernel interface (NO mode signal)
...
//                      rows x (w0,w1). Unused tail slots are ignored.
