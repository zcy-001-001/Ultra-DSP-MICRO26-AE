...
void W4A5_P(
    ...
    ap_int<8> result7[NUM_DSP],
    ap_int<8> result8[NUM_DSP],
...
#pragma HLS PIPELINE II=1
            ...
            sum_a2 += (ap_int<32>)result5[pe_index] +
            ...
            sign_a2 += (ap_int<32>)sign5[pe_index] +
...
#define PACK_PORT(PORT_PTR, PORT_IDX) \
    pack_weight_port((PORT_PTR), (PORT_IDX), w1_arr, w2_arr, w3_arr, w4_arr)
...
extern "C" void gemv_kernel(
    ...
    static ap_int<8> result7_arr[NUM_DSP];
    static ap_int<8> result8_arr[NUM_DSP];
