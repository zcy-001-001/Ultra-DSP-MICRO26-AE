...
wire w1_sign, w2_sign,w3_sign, w4_sign;
wire [2:0] w1_mag, w2_mag,w3_mag, w4_mag;
...
assign LSB_Res2[2] = (w2_mag[0] & a1_mag[2]) ^ (w2_mag[1] & a1_mag[1]) ^ (w2_mag[2] & a1_mag[0]) ^ c1_for_lsb2;
...
assign LSB_Res7[0] =  w3_mag[0] & a2_mag[0];
assign LSB_Res7[1] = (w3_mag[0] & a2_mag[1]) ^ (w3_mag[1] & a2_mag[0]);


assign LSB_Res8[0] =  w4_mag[0] & a2_mag[0];
assign LSB_Res8[1] = (w4_mag[0] & a2_mag[1]) ^ (w4_mag[1] & a2_mag[0]);
...
wire [17:0] dsp_B;
assign dsp_B = {1'b0, w4_mag, 2'b0, w3_mag, 2'b0, w2_mag, 1'b0, w1_mag};
