...
reg [9:0] signs_r1;
reg [1:0]  LSB_Res2_r1, LSB_Res3_r1, LSB_Res4_r1;
reg [2:0]  LSB_Res5_r1;
reg [1:0]  LSB_Res7_r1, LSB_Res8_r1, LSB_Res9_r1;
reg [2:0]  LSB_Res10_r1;


reg [9:0] signs_r2;
reg [1:0]  LSB_Res2_r2, LSB_Res3_r2, LSB_Res4_r2;
reg [2:0]  LSB_Res5_r2;
reg [1:0]  LSB_Res7_r2, LSB_Res8_r2, LSB_Res9_r2;
reg [2:0]  LSB_Res10_r2;


reg [9:0] signs_r3;
reg [1:0]  LSB_Res2_r3, LSB_Res3_r3, LSB_Res4_r3;
reg [2:0]  LSB_Res5_r3;
reg [1:0]  LSB_Res7_r3, LSB_Res8_r3, LSB_Res9_r3;
reg [2:0]  LSB_Res10_r3;
...
wire [1:0] w1_mag, w2_mag, w3_mag, w4_mag, w5_mag;
...
wire [1:0] LSB_Res2, LSB_Res3, LSB_Res4;
wire [2:0] LSB_Res5;
...
assign c1_for_lsb5 = (w5_mag[0] & a1_mag[1]) & (w5_mag[1] & a1_mag[0]);
assign LSB_Res5[2] = (w5_mag[0] & a1_mag[2]) ^ (w5_mag[1] & a1_mag[1]) ^ (w5_mag[2] & a1_mag[0]) ^ c1_for_lsb5;




assign LSB_Res7[0] = w2_mag[0] & a2_mag[0];
assign LSB_Res7[1] = (w2_mag[0] & a2_mag[1]) ^ (w2_mag[1] & a2_mag[0]);
...
assign LSB_Res9[0] = w4_mag[0] & a2_mag[0];
assign LSB_Res9[1] = (w4_mag[0] & a2_mag[1]) ^ (w4_mag[1] & a2_mag[0]);


wire c1_for_lsb10;
assign c1_for_lsb10 = (w5_mag[0] & a2_mag[1]) & (w5_mag[1] & a2_mag[0]);
assign LSB_Res10[0] = w5_mag[0] & a2_mag[0];
assign LSB_Res10[1] = (w5_mag[0] & a2_mag[1]) ^ (w5_mag[1] & a2_mag[0]);
assign LSB_Res10[2] = (w5_mag[0] & a2_mag[2]) ^ (w5_mag[1] & a2_mag[1]) ^ c1_for_lsb10;
...
wire [17:0] dsp_B;
assign dsp_B = {1'b0, w5_mag, 1'b0, w4_mag, 2'b0, w3_mag, 2'b0, w2_mag, 2'b0, w1_mag};


wire [26:0] dsp_A;
assign dsp_A = {2'b0, a2_mag,17'b0, a1_mag};
...
wire [5:0] res5_mag_comb, res6_mag_comb, res7_mag_comb, res8_mag_comb;
wire [5:0] res9_mag_comb, res10_mag_comb;
...
assign res5_mag_comb  = {dsp_P[20:18],  LSB_Res5_r3};    
assign res6_mag_comb  =  dsp_P[26:21];                     
assign res7_mag_comb  = {dsp_P[30:27],  LSB_Res7_r3};    
assign res8_mag_comb  = {dsp_P[34:31],  LSB_Res8_r3};    
assign res9_mag_comb  = {dsp_P[38:35],  LSB_Res9_r3};    
assign res10_mag_comb = {dsp_P[41:39],  LSB_Res10_r3};   
...
assign result8  = {1'b0,res8_mag_comb}  ^ {7{signs_r3[7]}};
assign result9  = {1'b0,res9_mag_comb}  ^ {7{signs_r3[8]}};
assign result10 = {1'b0,res10_mag_comb} ^ {7{signs_r3[9]}};
