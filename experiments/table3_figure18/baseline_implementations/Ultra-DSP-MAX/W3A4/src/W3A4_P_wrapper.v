...
module W3A4_P #(
    ...
    input wire [PE_ADDR_BITS-1:0] result10_address,
    input wire result10_ce,
    input wire result10_we,
    output wire [R_BUS_BITS-1:0] result10,

    input wire [PE_ADDR_BITS-1:0] result11_address,
    input wire result11_ce,
    input wire result11_we,
    output wire [R_BUS_BITS-1:0] result11,

    input wire [PE_ADDR_BITS-1:0] result12_address,
    input wire result12_ce,
    input wire result12_we,
    output wire [R_BUS_BITS-1:0] result12,
    ...
    input wire [PE_ADDR_BITS-1:0] sign9_address,
    input wire sign9_ce,
    input wire sign9_we,
    output wire [S_BUS_BITS-1:0] sign9,

    input wire [PE_ADDR_BITS-1:0] sign10_address,
    input wire sign10_ce,
    input wire sign10_we,
    output wire [S_BUS_BITS-1:0] sign10,

    input wire [PE_ADDR_BITS-1:0] sign11_address,
    input wire sign11_ce,
    input wire sign11_we,
    output wire [S_BUS_BITS-1:0] sign11,

    input wire [PE_ADDR_BITS-1:0] sign12_address,
    input wire sign12_ce,
    input wire sign12_we,
    output wire [S_BUS_BITS-1:0] sign12
);
...
generate
    for (col = 0; col < ARRAY_COLS; col = col + 1) begin : col_gen
        for (row = 0; row < ARRAY_ROWS; row = row + 1) begin : row_gen
            ...
            wire [2:0] w3_local = w3[W_OFFSET +: W_BITS];
            wire [2:0] w4_local = w4[W_OFFSET +: W_BITS];
            wire [2:0] w5_local = w5[W_OFFSET +: W_BITS];
            wire [2:0] w6_local = w6[W_OFFSET +: W_BITS];

            wire [3:0] a1_local = a1[A_OFFSET +: A_BITS];
            wire [3:0] a2_local = a2[A_OFFSET +: A_BITS];

            wire [5:0] result1_local;
            wire [5:0] result2_local;
            wire [5:0] result3_local;
            wire [5:0] result4_local;
            wire [5:0] result5_local;
            wire [5:0] result6_local;
            wire [5:0] result7_local;
            wire [5:0] result8_local;
            wire [5:0] result9_local;
            wire [5:0] result10_local;
            wire [5:0] result11_local;
            wire [5:0] result12_local;
            wire sign1_local;
            wire sign2_local;
            wire sign3_local;
            wire sign4_local;
            ...
            INT4_INT3_P dsp_core (
                ...
                .result10(result10_local),
                .result11(result11_local),
                .result12(result12_local),
                .sign1(sign1_local),
                .sign2(sign2_local),
                .sign3(sign3_local),
                .sign4(sign4_local),
            ...
            assign result10[R_OFFSET +: R_BITS] = result10_local;
            assign result11[R_OFFSET +: R_BITS] = result11_local;
            assign result12[R_OFFSET +: R_BITS] = result12_local;
            ...
            assign sign9[PE_INDEX] = sign9_local;
            assign sign10[PE_INDEX] = sign10_local;
            assign sign11[PE_INDEX] = sign11_local;
            assign sign12[PE_INDEX] = sign12_local;
        end
    end
endgenerate
