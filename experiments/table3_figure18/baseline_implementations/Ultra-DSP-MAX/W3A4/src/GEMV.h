...
#define P_WEIGHTS_PER_PE 6
#define P_ACT_GROUPS 2
...
// Kernel interface
//   act_packed layout  : [a1(rows), a2(rows)]
//   output layout      : [sum_a1(cols), sum_a2(cols)]
//   weight_colN layout : up to LOGICAL_COLS_PER_WEIGHT_PORT logical columns.
//                        Each logical column is stored in row-major order as
//                        rows x (w1, w2, w3, w4, w5, w6). Weight words keep
//                        the raw sign-bit plus magnitude-bit encoding expected
//                        by W3A4_P.v.
