...
void W3A4_P(
    ...
    ap_int<6> result1[NUM_DSP],
    ap_int<6> result2[NUM_DSP],
    ap_int<6> result3[NUM_DSP],
    ap_int<6> result4[NUM_DSP],
    ap_int<6> result5[NUM_DSP],
    ap_int<6> result6[NUM_DSP],
    ap_int<6> result7[NUM_DSP],
    ap_int<6> result8[NUM_DSP],
    ap_int<6> result9[NUM_DSP],
    ap_int<6> result10[NUM_DSP],
    ap_int<6> result11[NUM_DSP],
    ap_int<6> result12[NUM_DSP],
    ...
    ap_uint<1> sign11[NUM_DSP],
    ap_uint<1> sign12[NUM_DSP]);
...
#pragma HLS PIPELINE II=1
            ...
            sum_a2 += (ap_int<32>)result7[pe_index] +
                      (ap_int<32>)result8[pe_index] +
                      (ap_int<32>)result9[pe_index] +
                      (ap_int<32>)result10[pe_index] +
                      (ap_int<32>)result11[pe_index] +
                      (ap_int<32>)result12[pe_index];
            ...
            sign_a1 += (ap_int<32>)sign1[pe_index] +
                       ...
                       (ap_int<32>)sign6[pe_index];
            sign_a2 += (ap_int<32>)sign7[pe_index] +
                       (ap_int<32>)sign8[pe_index] +
                       (ap_int<32>)sign9[pe_index] +
                       (ap_int<32>)sign10[pe_index] +
                       (ap_int<32>)sign11[pe_index] +
                       (ap_int<32>)sign12[pe_index];
        }
...
#define PACK_PORT(PORT_PTR, PORT_IDX) \
    pack_weight_port((PORT_PTR), (PORT_IDX), w1_arr, w2_arr, w3_arr, w4_arr, w5_arr, w6_arr)
...
extern "C" void gemv_kernel(
    ...
    static ap_int<3> w6_arr[NUM_DSP];
    static ap_int<4> a1_arr[DSP_ARRAY_ROWS];
    static ap_int<4> a2_arr[DSP_ARRAY_ROWS];

    static ap_int<6> result1_arr[NUM_DSP];
    static ap_int<6> result2_arr[NUM_DSP];
    static ap_int<6> result3_arr[NUM_DSP];
    static ap_int<6> result4_arr[NUM_DSP];
    static ap_int<6> result5_arr[NUM_DSP];
    static ap_int<6> result6_arr[NUM_DSP];
    static ap_int<6> result7_arr[NUM_DSP];
    static ap_int<6> result8_arr[NUM_DSP];
    static ap_int<6> result9_arr[NUM_DSP];
    static ap_int<6> result10_arr[NUM_DSP];
    static ap_int<6> result11_arr[NUM_DSP];
    static ap_int<6> result12_arr[NUM_DSP];
    ...
    static ap_uint<1> sign11_arr[NUM_DSP];
    static ap_uint<1> sign12_arr[NUM_DSP];
