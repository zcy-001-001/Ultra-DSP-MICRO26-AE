...
#pragma HLS PIPELINE II=1
            ...
            const ap_int<4> weight_val = weight_port[weight_idx];
...
#pragma HLS PIPELINE II=1
            ...
            if (lane == 0) {
                ...
                sum += (ap_int<32>)result4[pe_index] +
...
extern "C" void gemv_kernel(
    ...
    DEEPBURNING_4096(
        w1_arr, w2_arr,
        a1_arr, a2_arr, a3_arr,
        result1_arr, result2_arr, result3_arr,
        result4_arr, result5_arr, result6_arr
    );
