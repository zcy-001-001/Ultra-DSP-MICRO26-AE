...
module tb_MXFP4_E2M1_MAG1_NormalNonOverlap;
reg clk = 1'b0;
always #5 clk = ~clk;
...
MXFP4_E2M1_MAG1_NormalNonOverlap dut (
    .clk(clk),
    .w0(w0),
    .w1(w1),
    .a0(a0),
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS MXFP4_E2M1_MAG1_NormalNonOverlap trials=4096 products=18");
    end else begin
        $display("FAIL MXFP4_E2M1_MAG1_NormalNonOverlap failures=%0d", failures);
    end
    $finish;
end
