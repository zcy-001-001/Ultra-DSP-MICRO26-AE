...
module tb_FP4_E1M2_NoPackingScalar;
reg clk = 1'b0;
always #5 clk = ~clk;
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS FP4_E1M2_NoPackingScalar trials=4096 products=1");
    end else begin
        $display("FAIL FP4_E1M2_NoPackingScalar failures=%0d", failures);
    end
    $finish;
end
