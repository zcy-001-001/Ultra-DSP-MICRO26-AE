...
module tb_FP10_E4M5_NormalNonOverlap;
reg clk = 1'b0;
always #5 clk = ~clk;
...
FP10_E4M5_NormalNonOverlap dut (
    .clk(clk),
    .w0(w0),
    .w1(w1),
    .a0(a0),
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS FP10_E4M5_NormalNonOverlap trials=4096 products=4");
    end else begin
        $display("FAIL FP10_E4M5_NormalNonOverlap failures=%0d", failures);
    end
    $finish;
end
