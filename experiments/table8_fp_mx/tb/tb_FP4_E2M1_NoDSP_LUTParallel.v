...
module tb_FP4_E2M1_NoDSP_LUTParallel;
reg clk = 1'b0;
always #5 clk = ~clk;
...
FP4_E2M1_NoDSP_LUTParallel dut (
    .clk(clk),
    .w0(w0),
    .w1(w1),
    .w2(w2),
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS FP4_E2M1_NoDSP_LUTParallel trials=4096 products=36");
    end else begin
        $display("FAIL FP4_E2M1_NoDSP_LUTParallel failures=%0d", failures);
    end
    $finish;
end
