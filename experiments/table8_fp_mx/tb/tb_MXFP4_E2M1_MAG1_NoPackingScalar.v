...
module tb_MXFP4_E2M1_MAG1_NoPackingScalar;
reg clk = 1'b0;
always #5 clk = ~clk;
...
MXFP4_E2M1_MAG1_NoPackingScalar dut (
    .clk(clk),
    .w0(w0),
    .a0(a0),
    .mag0(mag0),
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS MXFP4_E2M1_MAG1_NoPackingScalar trials=4096 products=1");
    end else begin
        $display("FAIL MXFP4_E2M1_MAG1_NoPackingScalar failures=%0d", failures);
    end
    $finish;
end
