...
module tb_FP8_E3M4_NoDSP_LUTParallel;
reg clk = 1'b0;
always #5 clk = ~clk;
...
FP8_E3M4_NoDSP_LUTParallel dut (
    .clk(clk),
    .w0(w0),
    .w1(w1),
    .a0(a0),
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS FP8_E3M4_NoDSP_LUTParallel trials=4096 products=6");
    end else begin
        $display("FAIL FP8_E3M4_NoDSP_LUTParallel failures=%0d", failures);
    end
    $finish;
end
