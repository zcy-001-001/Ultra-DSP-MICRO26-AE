...
module tb_FP8_E4M3_UltraDSP_Packing;
reg clk = 1'b0;
always #5 clk = ~clk;
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS FP8_E4M3_UltraDSP_Packing trials=4096 products=10");
    end else begin
        $display("FAIL FP8_E4M3_UltraDSP_Packing failures=%0d", failures);
    end
    $finish;
end
