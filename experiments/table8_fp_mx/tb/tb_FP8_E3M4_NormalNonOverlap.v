...
module tb_FP8_E3M4_NormalNonOverlap;
reg clk = 1'b0;
always #5 clk = ~clk;
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS FP8_E3M4_NormalNonOverlap trials=4096 products=4");
    end else begin
        $display("FAIL FP8_E3M4_NormalNonOverlap failures=%0d", failures);
    end
    $finish;
end
