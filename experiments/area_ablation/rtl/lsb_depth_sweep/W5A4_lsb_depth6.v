...
module W5A4_lsb_depth6(
    input wire [3:0] w_mag,
    input wire [2:0] a_mag,
    output wire [5:0] lsb
);

wire [5:0] partial_0 = w_mag[0] ? {1'b0, 1'b0, 1'b0, a_mag[2], a_mag[1], a_mag[0]} : 6'b0;
wire [5:0] partial_1 = w_mag[1] ? {1'b0, 1'b0, a_mag[2], a_mag[1], a_mag[0], 1'b0} : 6'b0;
wire [5:0] partial_2 = w_mag[2] ? {1'b0, a_mag[2], a_mag[1], a_mag[0], 1'b0, 1'b0} : 6'b0;
wire [5:0] partial_3 = w_mag[3] ? {a_mag[2], a_mag[1], a_mag[0], 1'b0, 1'b0, 1'b0} : 6'b0;

wire [5:0] sum_0 = partial_0;
wire [5:0] sum_1 = sum_0 + partial_1;
wire [5:0] sum_2 = sum_1 + partial_2;
wire [5:0] sum_3 = sum_2 + partial_3;
assign lsb = sum_3;
