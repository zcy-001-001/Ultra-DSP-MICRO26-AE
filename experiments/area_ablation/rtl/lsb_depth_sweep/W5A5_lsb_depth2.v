...
module W5A5_lsb_depth2(
    input wire [3:0] w_mag,
    input wire [3:0] a_mag,
    output wire [1:0] lsb
);

wire [1:0] partial_0 = w_mag[0] ? {a_mag[1], a_mag[0]} : 2'b0;
wire [1:0] partial_1 = w_mag[1] ? {a_mag[0], 1'b0} : 2'b0;

wire [1:0] sum_0 = partial_0;
wire [1:0] sum_1 = sum_0 + partial_1;
assign lsb = sum_1;
