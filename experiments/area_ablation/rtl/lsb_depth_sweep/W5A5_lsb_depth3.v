...
module W5A5_lsb_depth3(
    input wire [3:0] w_mag,
    input wire [3:0] a_mag,
    output wire [2:0] lsb
);

wire [2:0] partial_0 = w_mag[0] ? {a_mag[2], a_mag[1], a_mag[0]} : 3'b0;
wire [2:0] partial_1 = w_mag[1] ? {a_mag[1], a_mag[0], 1'b0} : 3'b0;
wire [2:0] partial_2 = w_mag[2] ? {a_mag[0], 1'b0, 1'b0} : 3'b0;

wire [2:0] sum_0 = partial_0;
wire [2:0] sum_1 = sum_0 + partial_1;
wire [2:0] sum_2 = sum_1 + partial_2;
assign lsb = sum_2;
