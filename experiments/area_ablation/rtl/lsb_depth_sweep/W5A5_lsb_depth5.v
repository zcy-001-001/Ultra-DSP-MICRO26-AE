...
module W5A5_lsb_depth5(
    input wire [3:0] w_mag,
    input wire [3:0] a_mag,
    output wire [4:0] lsb
);

wire [4:0] partial_0 = w_mag[0] ? {1'b0, a_mag[3], a_mag[2], a_mag[1], a_mag[0]} : 5'b0;
wire [4:0] partial_1 = w_mag[1] ? {a_mag[3], a_mag[2], a_mag[1], a_mag[0], 1'b0} : 5'b0;
