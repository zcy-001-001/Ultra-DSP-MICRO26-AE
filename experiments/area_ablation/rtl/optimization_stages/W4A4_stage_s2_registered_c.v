 ...
 * Top module: W4A4_stage_s2_registered_c
 * Precision: W4A4
 * Stage: s2_registered_c
 * Source: Ultra-DSP-main/Area_Test_Ablation_Test/Ablation Experiment/Ablation Experiment.srcs/sources_1/new/W4A4_PD_opt12.v
 * Toggle summary: offline sign-magnitude weights; registered C-port; per-result two's-complement sign recovery
 */

module W4A4_stage_s2_registered_c(
