 ...
 * Top module: W3A4_stage_s3_xor_sign
 * Precision: W3A4
 * Stage: s3_xor_sign
 * Source: Ultra-DSP-main/DSP_Packaging_Verilog/W3A4/W3A4_Hybrid.v
 * Toggle summary: offline sign-magnitude weights; registered C-port; XOR-only magnitude/sign output
 */

module W3A4_stage_s3_xor_sign(
    input wire        clk,
    input wire        mode,
...
assign w8_sign = w8[2]; assign w8_mag = w8[1:0];
assign w9_sign = w9[2]; assign w9_mag = w9[1:0];
...
wire [47:0] dsp_C = (mode_r1 == 0) ? {
    11'b0, LSB_Res12_r1, 1'b0, LSB_Res11_r1, 1'b0, LSB_Res10_r1, 1'b0, LSB_Res9_r1, 1'b0,
    LSB_Res8_r1, 6'b0, LSB_Res6_r1, 1'b0, LSB_Res5_r1, 1'b0,
    LSB_Res4_r1, 1'b0, LSB_Res3_r1, 1'b0, LSB_Res2_r1, 3'b0
} : {
    22'b0, LSB_Res9_r1, 1'b0, LSB_Res8_r1, 1'b0, LSB_Res7_r1, 1'b0, LSB_Res6_r1, 1'b0,
    LSB_Res5_r1, 1'b0, LSB_Res4_r1, 1'b0, LSB_Res3_r1, 1'b0, LSB_Res2_r1, 3'b0
};
...
assign result1  = {1'b0, res1_mag}  ^ {6{signs_r3[0]}};
assign result2  = {1'b0, res2_mag}  ^ {6{signs_r3[1]}};
assign result3  = {1'b0, res3_mag}  ^ {6{signs_r3[2]}};
assign result4  = {1'b0, res4_mag}  ^ {6{signs_r3[3]}};
assign result5  = {1'b0, res5_mag}  ^ {6{signs_r3[4]}};
assign result6  = {1'b0, res6_mag}  ^ {6{signs_r3[5]}};
assign result7  = {1'b0, res7_mag}  ^ {6{signs_r3[6]}};
assign result8  = {1'b0, res8_mag}  ^ {6{signs_r3[7]}};
assign result9  = {1'b0, res9_mag}  ^ {6{signs_r3[8]}};
assign result10 = (mode_r3 == 0) ? ({1'b0, res10_mag} ^ {6{signs_r3[9]}})  : 6'b0;
assign result11 = (mode_r3 == 0) ? ({1'b0, res11_mag} ^ {6{signs_r3[10]}}) : 6'b0;
assign result12 = (mode_r3 == 0) ? ({1'b0, res12_mag} ^ {6{signs_r3[11]}}) : 6'b0;
