 ...
 * Top module: W4A4_stage_s1_weight_offline
 * Precision: W4A4
 * Stage: s1_weight_offline
 * Source: Ultra-DSP-main/Area_Test_Ablation_Test/Ablation Experiment/Ablation Experiment.srcs/sources_1/new/W4A4_PD_opt1.v
 * Toggle summary: offline sign-magnitude weights; combinational C-port; per-result two's-complement sign recovery
 */

module W4A4_stage_s1_weight_offline(
