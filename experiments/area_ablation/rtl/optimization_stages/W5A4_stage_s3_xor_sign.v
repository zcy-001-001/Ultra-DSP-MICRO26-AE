 ...
 * Top module: W5A4_stage_s3_xor_sign
 * Precision: W5A4
 * Stage: s3_xor_sign
...
wire [47:0] dsp_C = (mode_r1 == 0) ? {
    ...
    LSB_Res4_r1, 3'b0, LSB_Res3_r1, 2'b0, LSB_Res2_3bit_r1, 4'b0
} : {
    24'b0, LSB_Res5_r1, 3'b0, LSB_Res4_r1, 4'b0, 
    {1'b0, LSB_Res3_r1[0]}, 5'b0, LSB_Res2_1bit_r1, 6'b0
};
...
assign result1 = {1'b0, res1_mag} ^ {8{signs_r3[0]}};
assign result2 = {1'b0, res2_mag} ^ {8{signs_r3[1]}};
assign result3 = {1'b0, res3_mag} ^ {8{signs_r3[2]}};
assign result4 = {1'b0, res4_mag} ^ {8{signs_r3[3]}};
assign result5 = (mode_r3 == 0) ? ({1'b0, res5_mag} ^ {8{signs_r3[4]}}) : ({1'b0, res5_mag} ^ {8{signs_r3[4]}});
assign result6 = (mode_r3 == 0) ? ({1'b0, res6_mag} ^ {8{signs_r3[5]}}) : 8'b0;
assign result7 = (mode_r3 == 0) ? ({1'b0, res7_mag} ^ {8{signs_r3[6]}}) : 8'b0;
assign result8 = (mode_r3 == 0) ? ({1'b0, res8_mag} ^ {8{signs_r3[7]}}) : 8'b0;
