 ...
 * Top module: W5A5_stage_s3_xor_sign
 * Precision: W5A5
 * Stage: s3_xor_sign
...
wire [47:0] dsp_C = (mode_r1 == 0) ? {
    12'b0, LSB_Res6_r1, 5'b0, LSB_Res5_1bit_r1, 13'b0,
    LSB_Res3_r1, 5'b0, LSB_Res2_1bit_r1, 7'b0
} : {
    23'b0, LSB_Res5_3bit_r1, 2'b0, LSB_Res4_r1, 3'b0,
    LSB_Res3_r1, 4'b0, LSB_Res2_2bit_r1, 6'b0
};
...
assign result1  = res1_mag ^ {8{signs_r3[0]}};
assign result2  = res2_mag ^ {8{signs_r3[1]}};
assign result3  = res3_mag ^ {8{signs_r3[2]}};
assign result4  = (mode_r3 == 0) ? res4_mag : (res4_mag ^ {8{signs_r3[3]}});
assign result5  = (mode_r3 == 0) ? (res5_mag ^ {8{signs_r3[4]}}) : (res5_mag ^ {8{signs_r3[4]}});
assign result6  = (mode_r3 == 0) ? (res6_mag ^ {8{signs_r3[5]}}) : 8'b0;
