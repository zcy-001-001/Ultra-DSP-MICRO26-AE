 ...
 * Top module: W3A5_stage_s0_original
 * Precision: W3A5
 * Stage: s0_original
...
wire [2:0] w1_temp_mag, w2_temp_mag, w3_temp_mag, w4_temp_mag, w5_temp_mag, w6_temp_mag, w7_temp_mag;
...
wire [47:0] dsp_C = (mode == 0) ? {
    ...
    9'b0, LSB_Res10, 1'b0, LSB_Res9, 2'b0, LSB_Res8, 2'b0, LSB_Res7, 7'b0, LSB_Res5, 
    1'b0, LSB_Res4, 2'b0, LSB_Res3, 2'b0, LSB_Res2, 4'b0
} : {
    
    22'b0, LSB_Res7, 2'b0, LSB_Res6_2bit, 2'b0, LSB_Res5[1:0], 2'b0, LSB_Res4, 2'b0, LSB_Res3, 2'b0, LSB_Res2, 4'b0
};
