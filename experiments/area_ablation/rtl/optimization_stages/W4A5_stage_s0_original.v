 ...
 * Top module: W4A5_stage_s0_original
 * Precision: W4A5
 * Stage: s0_original
...
wire [2:0] w1_mag, w2_mag, w3_mag, w4_mag, w5_mag, w6_mag;
wire [3:0] w1_temp_mag, w2_temp_mag, w3_temp_mag, w4_temp_mag, w5_temp_mag, w6_temp_mag;
...
wire [47:0] dsp_C = (mode == 0) ? {
    ...
    LSB_Res4, 3'b0, LSB_Res3, 2'b0, LSB_Res2, 4'b0
} : {
    22'b0, LSB_Res6, 2'b0, LSB_Res5, 3'b0, LSB_Res4,
    3'b0, LSB_Res3, 2'b0, LSB_Res2, 4'b0
};
