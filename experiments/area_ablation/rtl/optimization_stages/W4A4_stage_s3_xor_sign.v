 ...
 * Top module: W4A4_stage_s3_xor_sign
 * Precision: W4A4
 * Stage: s3_xor_sign
 * Source: Ultra-DSP-main/Area_Test_Ablation_Test/Compensation_Breakdown_Analysis/Compensation_Breakdown_Analysis.srcs/sources_1/new/W4A4_Hybrid.v
 * Toggle summary: offline sign-magnitude weights; registered C-port; XOR-only magnitude/sign output
 */

module W4A4_stage_s3_xor_sign(
