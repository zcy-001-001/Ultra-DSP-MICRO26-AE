...
set rtl_dir [file join $root_dir "rtl" "lsb_depth_sweep"]
set rtl_files [lsort [glob -nocomplain [file join $rtl_dir "*.v"]]]

if {[llength $rtl_files] == 0} {
    puts "ERROR: no LSB-depth RTL files found. Run scripts/generate_area_ablation.py first."
    exit 1
}
...
puts "Part: $part"
puts "Output: $out_dir"
puts "LSB design count: [llength $rtl_files]"
