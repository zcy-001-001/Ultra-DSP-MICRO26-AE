...
module INT4_INT3_P(
    ...
    output wire [5:0] result10,   
    output wire [5:0] result11,   
    output wire [5:0] result12 
);
...
wire [1:0] w1_mag, w2_mag, w3_mag, w4_mag, w5_mag, w6_mag;
...
wire [1:0] LSB_Res7, LSB_Res8, LSB_Res9, LSB_Res10, LSB_Res11, LSB_Res12;
...
assign LSB_Res8[0] = w2_mag[0] & a2_mag[0];
assign LSB_Res8[1] = (w2_mag[0] & a2_mag[1]) ^ (w2_mag[1] & a2_mag[0]);


assign LSB_Res9[0] = w3_mag[0] & a2_mag[0];
assign LSB_Res9[1] = (w3_mag[0] & a2_mag[1]) ^ (w3_mag[1] & a2_mag[0]);


assign LSB_Res10[0] = w4_mag[0] & a2_mag[0];
assign LSB_Res10[1] = (w4_mag[0] & a2_mag[1]) ^ (w4_mag[1] & a2_mag[0]);


assign LSB_Res11[0] = w5_mag[0] & a2_mag[0];
assign LSB_Res11[1] = (w5_mag[0] & a2_mag[1]) ^ (w5_mag[1] & a2_mag[0]);


assign LSB_Res12[0] = w6_mag[0] & a2_mag[0];
assign LSB_Res12[1] = (w6_mag[0] & a2_mag[1]) ^ (w6_mag[1] & a2_mag[0]);





wire [11:0] signs_comb;
assign signs_comb = {
    (w6_sign ^ a2_sign),  
    (w5_sign ^ a2_sign),  
    (w4_sign ^ a2_sign),  
...
wire [17:0] dsp_B;
assign dsp_B = {1'b0,w6_mag, 1'b0,w5_mag, 1'b0,w4_mag, 1'b0,w3_mag,  1'b0,w2_mag, 1'b0,w1_mag};

wire [26:0] dsp_A;
assign dsp_A = {4'b0, a2_mag, 17'b0, a1_mag};
...
always @(posedge clk) begin
    ...
    LSB_Res10_r1 <= LSB_Res10;
    LSB_Res11_r1 <= LSB_Res11;
    LSB_Res12_r1 <= LSB_Res12;
end
...
always @(posedge clk) begin
    ...
    LSB_Res10_r2 <= LSB_Res10_r1;
    LSB_Res11_r2 <= LSB_Res11_r1;
    LSB_Res12_r2 <= LSB_Res12_r1;
end
...
always @(posedge clk) begin
    ...
    LSB_Res10_r3 <= LSB_Res10_r2;
    LSB_Res11_r3 <= LSB_Res11_r2;
    LSB_Res12_r3 <= LSB_Res12_r2;
end
...
wire [4:0] res5_mag_comb, res6_mag_comb, res7_mag_comb, res8_mag_comb;
wire [4:0] res9_mag_comb, res10_mag_comb, res11_mag_comb, res12_mag_comb;
...
assign res7_mag_comb  =  dsp_P[24:20];  
assign res8_mag_comb  = {dsp_P[27:25],  LSB_Res8_r3};  
assign res9_mag_comb  = {dsp_P[30:28],  LSB_Res9_r3};  
assign res10_mag_comb = {dsp_P[33:31],  LSB_Res10_r3}; 
assign res11_mag_comb = {dsp_P[36:34],  LSB_Res11_r3};
assign res12_mag_comb = {dsp_P[39:37],  LSB_Res12_r3};  





assign result1 = signs_r3[0] ? -$signed({1'b0, res1_mag_comb}) : {1'b0, res1_mag_comb};
assign result2 = signs_r3[1] ? -$signed({1'b0, res2_mag_comb}) : {1'b0, res2_mag_comb};
assign result3 = signs_r3[2] ? -$signed({1'b0, res3_mag_comb}) : {1'b0, res3_mag_comb};
assign result4 = signs_r3[3] ? -$signed({1'b0, res4_mag_comb}) : {1'b0, res4_mag_comb};
assign result5 = signs_r3[4] ? -$signed({1'b0, res5_mag_comb}) : {1'b0, res5_mag_comb};
assign result6 = signs_r3[5] ? -$signed({1'b0, res6_mag_comb}) : {1'b0, res6_mag_comb};
assign result7 = signs_r3[6] ? -$signed({1'b0, res7_mag_comb}) : {1'b0, res7_mag_comb};
assign result8 = signs_r3[7] ? -$signed({1'b0, res8_mag_comb}) : {1'b0, res8_mag_comb};
assign result9 = signs_r3[8] ? -$signed({1'b0, res9_mag_comb}) : {1'b0, res9_mag_comb};
assign result10 = signs_r3[9] ? -$signed({1'b0, res10_mag_comb}) : {1'b0, res10_mag_comb};
assign result11 = signs_r3[10] ? -$signed({1'b0, res11_mag_comb}) : {1'b0, res11_mag_comb};
assign result12 = signs_r3[11] ? -$signed({1'b0, res12_mag_comb}) : {1'b0, res12_mag_comb};
