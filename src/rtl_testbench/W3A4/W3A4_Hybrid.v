...
assign result10 = signs_r3[9] ? -$signed({1'b0, res10_mag}) : {1'b0, res10_mag};
assign result11 = signs_r3[10] ?-$signed({1'b0, res11_mag}) : {1'b0, res11_mag};
assign result12 = signs_r3[11] ?-$signed({1'b0, res12_mag}) : {1'b0, res12_mag};
