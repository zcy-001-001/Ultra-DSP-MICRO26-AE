...
task run_test;
    input [3:0] w1_in, w2_in, w3_in;
    input [3:0] a1_in, a2_in, a3_in;
    input [80*8-1:0] test_name;

    reg signed [3:0] w1s, w2s, w3s;
    ...
    begin
        ...
        if (!compare_enable) begin
            ...
            if (test_pass) begin
                ...
                $display("w = {%0d,%0d,%0d}, a={%0d,%0d,%0d}", w1s, w2s, w3s, a1s, a2s, a3s);
...
initial begin
    ...
    run_test(4'b0001,4'b0010,4'b0011,
             4'b0001,4'b0010,4'b0011,
             "1,2,3 x 1,2,3");
    run_test(4'b0011,4'b0011,4'b0011,
    ...
    run_test(4'b0001,4'b0010,4'b0011,
             ...
             "1,2,3 x -1,-2,-3");
    run_test(4'b0011,4'b0010,4'b0001,
             4'b1101,4'b1011,4'b1001,
             "3,2,1 x -3,-5,-7");
    display_group_summary("Group 4 Summary");

    $display("\n=== Group 5: Neg x Pos ===");
    run_test(4'b1001,4'b1010,4'b1011,
             4'b0001,4'b0010,4'b0011,
             "-1,-2,-3 x 1,2,3");
    run_test(4'b1011,4'b1011,4'b1011,
             4'b0111,4'b0101,4'b0011,
             "all -3 x 7,5,3");
    display_group_summary("Group 3 Summary");
    ...
    run_test(4'b1001,4'b1010,4'b1011,
             4'b1111,4'b1110,4'b1101,
             "-1,-2,-3 x -1,-2,-3");
    run_test(4'b1111,4'b1111,4'b1111,
             4'b1111,4'b1111,4'b1111,
             "all -1 x -1");
    display_group_summary("Group 6 Summary");

    $display("\n=== Group 7: Zero / boundary ===");
    run_test(4'b0000,4'b0000,4'b0000,
             4'b0111,4'b1111,4'b0000,
             "all w=0");
    run_test(4'b0111,4'b0111,4'b0111,
             4'b0111,4'b0111,4'b0111,
             "+7 x +7");
    run_test(4'b1001,4'b1001,4'b1001,
             4'b1001,4'b1001,4'b1001,
             "-7 x -7");
