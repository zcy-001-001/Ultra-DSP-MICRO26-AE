...
wire [6:0] result1, result2, result3, result4, result5, result6, result7, result8, result9;
...
task run_test;
    ...
    input [3:0]  a1_in, a2_in, a3_in;
    input [80*8-1:0] test_name;

    reg signed [3:0] w1s, w2s, w3s, w4s, w5s, w6s, w7s;
    reg signed [3:0] a1s, a2s, a3s;
    reg signed [6:0] exp1, exp2, exp3, exp4, exp5, exp6, exp7, exp8, exp9;
    reg test_pass;
    begin
        ...
        if (!compare_enable) begin
            ...
            if (test_pass) begin
                ...
                $display("w = {%0d,%0d,%0d,%0d,%0d,%0d,%0d}, a={%0d,%0d,%0d}",
                         w1s,w2s,w3s,w4s,w5s,w6s,w7s,a1s,a2s,a3s);
...
initial begin
    ...
    $display("========================================");
    $display("  Hybrid_INT4_INT4_PD Testbench");
    $display("========================================");
    ...
    $display("\n=== Group 1: Warmup ===");
    run_test(1'b0,
             4'b0000,4'b0000,4'b0000,4'b0000,4'b0000,4'b0000,4'b0000,
    ...
    $display("\n=== Group 2: Warmup ===");
    run_test(1'b0,
             4'b0001,4'b0010,4'b0011,4'b0000,4'b0000,4'b0000,4'b0000,
    ...
    run_test(1'b0,
             ...
             "P: 1,2,3 x 1,2,3");
    run_test(1'b0,
             4'b0011,4'b0011,4'b0011,4'b0000,4'b0000,4'b0000,4'b0000,
             4'b0111,4'b0101,4'b0011,
             "P: all +3 x {7,5,3}");
    display_group_summary("Group 3 Summary");

    $display("\n=== Group 4: Packaging neg/zero ===");
    run_test(1'b0,
             4'b1001,4'b1010,4'b1011,4'b0000,4'b0000,4'b0000,4'b0000,
             4'b1111,4'b1110,4'b1101,
             "P: -1,-2,-3 x -1,-2,-3");
    run_test(1'b0,
             4'b0000,4'b0000,4'b0000,4'b0000,4'b0000,4'b0000,4'b0000,
             4'b0111,4'b1111,4'b0000,
             "P: all w=0");
    ...
    run_test(1'b1,
             ...
             "D: 1..7 x +1");
    run_test(1'b1,
             4'b1001,4'b1010,4'b1011,4'b1100,4'b1101,4'b1110,4'b1111,
             4'b1111,4'b0000,4'b0000,
             "D: -1..-7 x -1");
    run_test(1'b1,
             4'b0111,4'b0111,4'b0111,4'b0111,4'b0111,4'b0111,4'b0111,
             4'b1000,4'b0000,4'b0000,
             "D: a1=-8 clamp");
