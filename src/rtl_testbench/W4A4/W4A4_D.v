...
reg [6:0]  signs_r1;
reg [1:0]  LSB_Res2_r1, LSB_Res3_r1,  LSB_Res5_r1, LSB_Res6_r1, LSB_Res7_r1;
reg [2:0]  LSB_Res4_r1;


reg [6:0]  signs_r2;
reg [1:0]  LSB_Res2_r2, LSB_Res3_r2,  LSB_Res5_r2, LSB_Res6_r2, LSB_Res7_r2;
reg [2:0]  LSB_Res4_r2;

reg [6:0]  signs_r3;
reg [1:0]  LSB_Res2_r3, LSB_Res3_r3,  LSB_Res5_r3, LSB_Res6_r3, LSB_Res7_r3;
reg [2:0]  LSB_Res4_r3;
...
assign w1_sign = w1[3];
assign w1_mag  = w1[2:0];
assign w2_sign = w2[3];
assign w2_mag  = w2[2:0];
assign w3_sign = w3[3];
assign w3_mag  = w3[2:0];
assign w4_sign = w4[3];
assign w4_mag  = w4[2:0];
assign w5_sign = w5[3];
assign w5_mag  = w5[2:0];
assign w6_sign = w6[3];
assign w6_mag  = w6[2:0];
assign w7_sign = w7[3];
assign w7_mag  = w7[2:0];
...
wire [1:0] LSB_Res2, LSB_Res3,  LSB_Res5, LSB_Res6, LSB_Res7;
wire [2:0] LSB_Res4;
...
assign c1_for_lsb4 = (w4_mag[0] & a1_mag[1]) & (w4_mag[1] & a1_mag[0]);
assign LSB_Res4[2] = (w4_mag[0] & a1_mag[2]) ^ 
                     (w4_mag[1] & a1_mag[1]) ^ 
                     (w4_mag[2] & a1_mag[0]) ^ 
                     c1_for_lsb4;
...
wire [26:0] dsp_A;
assign dsp_A = {1'b0,w7_mag, 1'b0, w6_mag, 1'b0, w5_mag, 1'b0, w4_mag, w3_mag, 1'b0, w2_mag, 1'b0, w1_mag};
...
always @(posedge clk) begin
    // AE maintenance note: Vivado 2024.1 rejects the historical double-semicolon
    // spelling below as an empty sequential statement. Keep it commented for
    // provenance and use the equivalent single-semicolon assignment.
    // signs_r2 <= signs_r1;;
    signs_r2 <= signs_r1;
...
wire [5:0] res1_mag_comb, res2_mag_comb, res3_mag_comb, res4_mag_comb, res5_mag_comb, res6_mag_comb, res7_mag_comb;
...
assign res4_mag_comb = {dsp_P[16:14], LSB_Res4_r3};   
assign res5_mag_comb = {dsp_P[20:17], LSB_Res5_r3};   
assign res6_mag_comb = {dsp_P[24:21], LSB_Res6_r3};   
assign res7_mag_comb = {dsp_P[28:25], LSB_Res7_r3};   
