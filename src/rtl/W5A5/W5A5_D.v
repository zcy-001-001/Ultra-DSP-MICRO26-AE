...
reg [4:0]  signs_r1;
reg [1:0]  LSB_Res2_r1, LSB_Res3_r1;
reg [2:0]  LSB_Res4_r1, LSB_Res5_r1;


reg [4:0]  signs_r2;
reg [1:0]  LSB_Res2_r2, LSB_Res3_r2;
reg [2:0]  LSB_Res4_r2, LSB_Res5_r2;


reg [4:0]  signs_r3;
reg [1:0]  LSB_Res2_r3, LSB_Res3_r3;
reg [2:0]  LSB_Res4_r3, LSB_Res5_r3;
...
wire [1:0] LSB_Res2, LSB_Res3;
wire [2:0] LSB_Res4, LSB_Res5;




assign LSB_Res2 = {(w2_mag[0] & a1_mag[1]) ^ (w2_mag[1] & a1_mag[0]), w2_mag[0] & a1_mag[0]};


assign LSB_Res3 = {(w3_mag[0] & a1_mag[1]) ^ (w3_mag[1] & a1_mag[0]), w3_mag[0] & a1_mag[0]};


wire c1_res4 = (w4_mag[0] & a1_mag[1]) & (w4_mag[1] & a1_mag[0]);
assign LSB_Res4 = {
    (w4_mag[0] & a1_mag[2]) ^ (w4_mag[1] & a1_mag[1]) ^ (w4_mag[2] & a1_mag[0]) ^ c1_res4,
    (w4_mag[0] & a1_mag[1]) ^ (w4_mag[1] & a1_mag[0]),
    w4_mag[0] & a1_mag[0]
};


wire c1_res5 = (w5_mag[0] & a1_mag[1]) & (w5_mag[1] & a1_mag[0]);
assign LSB_Res5 = {
    (w5_mag[0] & a1_mag[2]) ^ (w5_mag[1] & a1_mag[1]) ^ (w5_mag[2] & a1_mag[0]) ^ c1_res5,
...
wire [7:0] res1_mag_comb, res2_mag_comb, res3_mag_comb, res4_mag_comb, res5_mag_comb;



assign res1_mag_comb = dsp_P[7:0];                     
assign res2_mag_comb = {dsp_P[13:8], LSB_Res2_r3};    
assign res3_mag_comb = {dsp_P[19:14], LSB_Res3_r3};   
assign res4_mag_comb = {dsp_P[24:20], LSB_Res4_r3};   
assign res5_mag_comb = {dsp_P[29:25], LSB_Res5_r3};   
