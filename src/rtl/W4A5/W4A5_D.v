...
reg [5:0]  signs_r1;
reg [1:0]  LSB_Res3_r1, LSB_Res4_r1, LSB_Res5_r1;
reg [2:0]  LSB_Res2_r1, LSB_Res6_r1;


reg [5:0]  signs_r2;
reg [1:0]  LSB_Res3_r2, LSB_Res4_r2, LSB_Res5_r2;
reg [2:0]  LSB_Res2_r2, LSB_Res6_r2;


reg [5:0]  signs_r3;
reg [1:0]  LSB_Res3_r3, LSB_Res4_r3, LSB_Res5_r3;
...
wire [1:0] LSB_Res3, LSB_Res4, LSB_Res5;
...
assign c1_for_lsb2 = (w2_mag[0] & a1_mag[1]) & (w2_mag[1] & a1_mag[0]);
assign LSB_Res2[2] = (w2_mag[0] & a1_mag[2]) ^ 
                     (w2_mag[1] & a1_mag[1]) ^ 
                     (w2_mag[2] & a1_mag[0]) ^ 
                     c1_for_lsb2;
...
assign c1_for_lsb6 = (w6_mag[0] & a1_mag[1]) & (w6_mag[1] & a1_mag[0]);
assign LSB_Res6[2] = (w6_mag[0] & a1_mag[2]) ^ 
                     (w6_mag[1] & a1_mag[1]) ^ 
                     (w6_mag[2] & a1_mag[0]) ^ 
                     c1_for_lsb6;
...
wire [26:0] dsp_A;
assign dsp_A = {1'b0, w6_mag, 1'b0, w5_mag, 2'b0, w4_mag, 2'b0, w3_mag, 2'b0, w2_mag, 1'b0, w1_mag};
...
assign res5_mag_comb = {dsp_P[25:21], LSB_Res5_r3};    
assign res6_mag_comb = {dsp_P[29:26], LSB_Res6_r3};    
