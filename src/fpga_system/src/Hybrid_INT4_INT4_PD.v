...
// Result2: Prefill(w1*a2) or Decoding(w2*a1)
...
// Result3: Prefill(w1*a3) or Decoding(w3*a1)
...
// Result4 (3 bits): Prefill(w2*a1) or Decoding(w4*a1)
...
// Result5: Prefill(w2*a2) or Decoding(w5*a1)
...
// Result6: Prefill(w2*a3) or Decoding(w6*a1)
...
// Result7 (2 bits): Prefill(w3*a1) or Decoding(w7*a1)
