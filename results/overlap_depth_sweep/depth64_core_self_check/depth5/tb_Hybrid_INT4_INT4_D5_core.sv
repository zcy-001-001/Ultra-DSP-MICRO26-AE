...
module tb_Hybrid_INT4_INT4_D5_core;
reg clk = 1'b0;
reg mode = 1'b0;
reg [3:0] w1;
reg [3:0] w2;
...
wire [6:0] result19;
wire [6:0] result20;
reg [31:0] seed = 32'h00000d69;
reg [31:0] rand_word;
integer cycle = 0;
integer i;
integer failures = 0;

Hybrid_INT4_INT4_D5_core dut(
    .clk(clk),
    .mode(mode),
    .w1(w1),
    .w2(w2),
    ...
    begin
        ...
        if (mode == 1'b0) begin
            ...
            if (mode == 1'b1) begin
                ...
                next_result[84 +: 7] = 7'b0;
                next_result[91 +: 7] = 7'b0;
                next_result[98 +: 7] = 7'b0;
                next_result[105 +: 7] = 7'b0;
                next_result[112 +: 7] = 7'b0;
                next_result[119 +: 7] = 7'b0;
                next_result[126 +: 7] = 7'b0;
                next_result[133 +: 7] = 7'b0;
            end
        end
    end
endtask
...
initial begin
    ...
    if (failures == 0) begin
        $display("PASS depth=5 core=Hybrid_INT4_INT4_D5_core trials=64");
    end
    $finish;
end
